...
const ProductDetail = () => {
   ...
   return (
      <div className="product-detail-container">
               ...
               <div className="detail-grid">
                  ...
                  <div className="detail-section">
                     ...
                     <div className="detail-item">
                        ...
                        <span className="value "><span className="stock">{product.stock || <span className="out-of-stock">{intl.formatMessage({ id: 'body_admin.product_management.detail_product.out_of_stock', defaultMessage: 'Hết hàng' })}</span>}</span></span>
                     </div>
                  ...
                  <div className="detail-section">
                     ...
                     <div className="detail-item">
                        ...
                        <span className="value"><span className="unit-text">3000</span></span>
                     </div>
                     <div className="detail-item">
                        ...
                        <span className="value"><span className="unit-text">2025-01-01</span></span>
                     </div>
                     <div className="detail-item">
                        ...
                        <span className="value"><span className="unit-text">1000</span></span>
                     </div>
                     <div className="detail-item">
         ...
         {/* Description Modal */}
         {showDescriptionModal && (
            <div className="description-modal-product">
