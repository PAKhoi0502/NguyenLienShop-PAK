...
const ProductDetail = () => {
   ...
   return (
      <div className="product-detail-container">
         <h1><FormattedMessage id="body_admin.product_management.detail_product.title" defaultMessage="Thông tin sản phẩm" /></h1>
         ...
         <div className="product-detail-card">
                                          ...
                                          {categoriesData.map((item, index) => (
                                             <span key={index} className="badge category-name">
                                                {item.nameCategory ||
                                                   ...
                                                   item.name ||
                                                   item.Category?.nameCategory ||
                                                   intl.formatMessage({ id: 'body_admin.product_management.detail_product.unknown_category', defaultMessage: 'Danh mục không xác định' })}
                                             </span>
                                          ))}
                                       </div>
                                    </div>
            ...
            <div className="card-footer">
               <button className="btn-edit" onClick={handleEdit}>
                  ✏️ <FormattedMessage id="body_admin.product_management.detail_product.edit_button" defaultMessage="Cập nhật sản phẩm" />
               </button>
